    ...
    public static void main(String[] args) {
        try {
            String[] QuoteOfTheDay = {
                ...
                "물러나서 조용하게 구하면 배울 수 있는 스승은 많다. 사람은 가는 곳마다 보는 것마다 모두 스승으로서 -맹자",
                ...
                "이룰수 없는 꿈을 꾸고 이길수 없는 적과 싸우며, 이룰수 없는 사랑을 하고 견딜 수 없는 고통을 견디고 -세르반테스",
            ...
            while (true) {
                ...
                String TodayQuote = QuoteOfTheDay[randNum.nextInt(QuoteOfTheDay.length)];
